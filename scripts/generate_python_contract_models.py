...
def generate_model(schema_filename: str, output_filename: str, class_name: str) -> None:
...
def main() -> None:
    ...
    for schema_filename, output_filename, class_name in SCHEMAS:
        generate_model(schema_filename, output_filename, class_name)

    subprocess.run(["ruff", "check", "--fix", str(OUTPUT_DIRECTORY)], check=True, cwd=ROOT)
