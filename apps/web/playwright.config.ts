...
const schedulerPort = playwrightPort + 10;
const schedulerRunUrl = `http://127.0.0.1:${schedulerPort}/internal/pipeline-runs`;
...
export default defineConfig({
  ...
  webServer: [
    {
      command: "pnpm --filter scheduler exec tsx src/main.ts",
      env: {
      ...
      url: `http://127.0.0.1:${schedulerPort}/health`,
    },
    {
